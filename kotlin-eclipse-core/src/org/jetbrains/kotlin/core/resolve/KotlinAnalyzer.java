...
public class KotlinAnalyzer {
    ...
    public static BindingContext analyzeProject(IJavaProject javaProject) {
        ...
        AnalyzeExhaust analyzeExhaust = AnalyzerFacadeForJVM.analyzeFilesWithJavaIntegration(
                ideaProject, getJetFiles(javaProject, ideaProject, applicationEnvironment), null, Predicates.<PsiFile>alwaysTrue());
        
        return analyzeExhaust.getBindingContext();
    }
    
    private static List<JetFile> getJetFiles(IJavaProject javaProject, Project ideaProject, JavaCoreApplicationEnvironment applicationEnvironment) {
